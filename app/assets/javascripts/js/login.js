...
(jQuery)( function( $ ){
		...
		function updateBarLoged(){
			var strFull = '	 <li class="right-menus javo-navi-login-button">'
						+	'	<a href="#" class="nav-right-button dropdown-toggle" title="Login"  data-toggle="dropdown"  >'
						+	'		<span class="glyphicon glyphicon-user"></span>'
						+	'	</a>'
						+	'	<ul class="dropdown-menu" role="menu">'
						+	'		<li><a href="/users"  >Trang cá nhân</a></li> '
						+	'		<li><a href="/plans/new"  >Tạo mới kế hoạch</a></li> '
						+	'		<li><a href="/places/new"  >Thêm địa điểm</a></li> '
						+	'		<li><a href="/collections/new" >Thêm bộ sưu tập</a></li> '
						+	'		<li><a href="/signout" class="signout" >Thoát</a></li> '
						+	'	</ul>'
						+	'</li> 		';
		...
		function updateBarNotLogin(){
			var strFull = '<li class="right-menus javo-navi-login-button">'
						...
						+	'</li>'
						+	'<li class="dropdown right-menus javo-navi-post-button">'
						+	'	<a href="#" class="dropdown-toggle nav-right-button button-icon-notice" title="Write"   data-javo-hover-menu data-target="#register_panel">'
